...
<div id="blur" class="back_g">
  ...
  <div>
    <div class="single-content-div center title">
      <span class="title">SerWice</span> <span class="subtitle">:Branch Inventory</span>
    </div>
    ...
    <div class="form-display-table glass">
      <table>
        ...
        <%
          ...
          if (iId.equals(null)){
            response.sendRedirect("inventory.jsp?message=Not Found!");
          }
          int branchId=Integer.parseInt(session.getAttribute("branchId").toString());
          try{
            ArrayList<String[]> results1 = inventoryItemBranchTable.select("Inventory_Item_Id,batchNo,quantity,handling_time","Branch_Id='"+branchId+"'AND Inventory_Item_Id="+iId);
            if(results1.isEmpty()){
              response.sendRedirect("inventory.jsp?message=Not Found!");
            }else{
